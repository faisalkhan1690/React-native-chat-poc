...
/**
 * Created by Kristian Frølund on 7/19/16. Copyright (c) 2016. Teletronics. All
 * rights reserved
 */

public class XmppServiceSmackImpl implements XmppService, ChatManagerListener, StanzaListener, ConnectionListener,
        ChatMessageListener, RosterLoadedListener {
    ...
    public void connect(String jid, String password, String authMethod, String hostname, Integer port) {
        ...
        XMPPTCPConnectionConfiguration.Builder confBuilder = XMPPTCPConnectionConfiguration.builder()
                .setServiceName(serviceName).setUsernameAndPassword(jidParts[0], password).setConnectTimeout(3000);
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    if (e instanceof SASLErrorException) {
                        XmppServiceSmackImpl.this.xmppServiceListener
                                .onLoginError(((SASLErrorException) e).getSASLFailure().toString());
                    } else {
    ...
    public void presence(String to, String type) {
        try {
            connection
                    .sendStanza(new Presence(Presence.Type.fromString(type), type, 1, Presence.Mode.fromString(type)));
    ...
    public void getPresence(String jid) {
        ...
        // Presence presence;
        // presence = roster.getPresence("swapnil@storm-devdb.zoylo.com");

        // logger.log(Level.INFO, Boolean.toString(presence.isAvailable()));

        MultiUserChatManager manager = MultiUserChatManager.getInstanceFor(connection);
        MultiUserChat multiUserChat = manager.getMultiUserChat("groupA");
        ...
        // });
        // return oldMessages;
        // logger.log(Level.INFO, oldMessages);
    }
